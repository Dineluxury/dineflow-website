    ...
    const res = await fetch(
      '/api/partners/register',
      {
        ...
        body: JSON.stringify({
          ...
          phone: form.phone,
          dineflowUsername: form.dineflowUsername,
          type: 'creator',
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    {[
                      ...
                      { key: 'phone', label: 'Phone Number (Used in Dineflow App)', placeholder: '0911 234 567', type: 'tel' },
                      { key: 'dineflowUsername', label: 'Dineflow App Username', placeholder: 'e.g. foodlover251', type: 'text' },
