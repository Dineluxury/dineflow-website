...
export default function FloatingButtons() {
  ...
  return (
    <div className={`fixed bottom-8 right-6 z-40 flex flex-col gap-3 transition-all duration-500 ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
      ...
      <button
        onClick={scrollTop}
        className="w-12 h-12 bg-[#1a1a1a] hover:bg-[#252525] border border-white/10 hover:border-orange-500/30 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-110"
        title="Back to top"
      >
