...
const steps = [
  { num: '01', icon: Smartphone, title: 'Browse Venues', desc: 'Open Dineflow and discover restaurants, hotels, and cafes near you. Filter by cuisine, rating, or pre-order availability.' },
  ...
  { num: '03', icon: CreditCard, title: 'Pay with Chapa', desc: 'Checkout securely in seconds using Chapa. Your order is confirmed and the kitchen starts immediately.' },
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
          ...
          <p style={{ color: '#6B7280', fontSize: '16px', maxWidth: '520px', margin: '1.5rem auto 0', lineHeight: 1.7 }}>
            Order from your phone, pay instantly with Chapa, and walk into a restaurant, hotel, or cafe where your food is already there.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '4rem' }}>
          ...
          <p style={{ color: '#9CA3AF', fontSize: '13px', marginTop: '12px' }}>Join our waitlist and we will notify you when the app launches.</p>
        </div>
      </div>
    </section>
  )
